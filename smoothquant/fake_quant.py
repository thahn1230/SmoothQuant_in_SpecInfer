...
#     @staticmethod
#     def from_float(
#         module, n_bits=4, weight_quant="per_channel", act_quant="per_token", quantize_output=False
#     ):
#         assert isinstance(module, torch.nn.Linear)
#         new_module = W8A8Linear(
#             module.in_features,
...
#         )
#         if weight_quant == "per_channel":
#             new_module.weight = quantize_weight_per_channel_absmax(module.weight, n_bits)
#         elif weight_quant == "per_tensor":
#             new_module.weight = quantize_weight_per_tensor_absmax(module.weight, n_bits)
#         else:
#             raise ValueError(f"Invalid weight_quant: {weight_quant}")
#         new_module.weight_quant_name = weight_quant
#         if module.bias is not None:
...
# def quantize_model(
#     model, n_bits=4, weight_quant="per_channel", act_quant="per_token", quantize_bmm_input=False
# ):
#     # Model selection and appropriate quantization application
#     from transformers.models.opt.modeling_opt import OPTPreTrainedModel
#     from transformers.models.llama.modeling_llama import LlamaPreTrainedModel
#     from transformers.models.mistral.modeling_mistral import MistralPreTrainedModel
#     from transformers.models.mixtral.modeling_mixtral import MixtralPreTrainedModel
